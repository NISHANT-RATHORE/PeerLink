        ...
        <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <div className="flex items-center">
                ...
                <button
                    ...
                    className="p-3 bg-blue-500 hover:bg-blue-600 text-white rounded-r-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500"
